...
img = mnist.train.images[1].reshape((28,28)) * 255
print(img)
img = np.array(img,dtype=np.int16)
cv.imwrite("8.jpg",img)
...
# 指定要查看的轮次
epoch_idx = [0, 5, 10, 20, 40, 60, 80, 100, 150, 299] # 一共300轮，不要越界
show_imgs = []
for i in epoch_idx:
    show_imgs.append(samples[i][1])#i代表在ipoch_idx中第几个论数，1表示的是输出simoid值，而非logits值
